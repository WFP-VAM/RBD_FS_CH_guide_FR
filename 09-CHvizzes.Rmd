...
[NGA_shpfile](https://github.com/WFP-VAM/RBD_FS_CH_guide_FR/blob/master/example_datasets/NGA_shpfile.zip?raw=true) 


### Syntaxe

Voici la syntaxe pour visualiser les indicateurs directs de sécurité alimentaire de CH
[example_CH_preliminaryFSresults_fromcsv_FR](https://github.com/WFP-VAM/RBD_FS_CH_guide_FR/blob/master/syntax/example_CH_preliminaryFSresults_fromcsv_FR.zip?raw=true) 
...
[example_CH_preliminaryFSresults_fromspss_FR](https://github.com/WFP-VAM/RBD_FS_CH_guide_FR/blob/master/syntax/example_CH_preliminaryFSresults_fromspss_FR.zip?raw=true) 
