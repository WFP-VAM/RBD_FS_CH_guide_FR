...
Télécharger une version .sav (spss) de l'ensemble de données à partir de Kobo/Ona/MoDa/ODK - utiliser [exampledataFrancais_raw](https://github.com/WFP-VAM/RBD_FS_CH_guide_FR/blob/main/example_datasets/exampledataFrancais_raw.sav) comme example.
